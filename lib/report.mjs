...
<div class="sub">${meta.generatedAtLocal} · SP500 实时市值前 ${meta.topN} + SPMO · RSI6&gt;${cfg.rsi.overbought} 超买 / &lt;${cfg.rsi.oversold} 超卖 · 通道 EMA12/36 · 144/169 · 576/676 · 数据源：东财 ${meta.srcEast} / Yahoo ${meta.srcYahoo ?? 0} / 腾讯兜底 ${meta.srcTx} / 失败 ${meta.srcFail}</div></div>
